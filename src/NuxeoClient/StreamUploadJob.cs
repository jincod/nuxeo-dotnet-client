...
namespace NuxeoClient
{
    ...
    public class StreamUploadJob
    {
        ...
        public StreamUploadJob(Blob blob)
        {
            Blob = blob;
        }
        ...
        public StreamUploadJob SetFileId(int fileId)
        {
            FileId = fileId;
            return this;
        }
        ...
        /// <returns>The current <see cref="UploadJob"/> instance.</returns>
        public StreamUploadJob SetChunked(bool isChunked)
        {
            IsChunked = isChunked;
            return this;
        }
        ...
        /// <returns>The current <see cref="UploadJob"/> instance.</returns>
        public StreamUploadJob SetChunkSize(int size)
        {
            ChunkSize = size;
            return this;
        }
